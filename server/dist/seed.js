...
const seedDatabase = async () => {
    try {
        ...
        await Service_model_1.default.deleteMany({});
        await Provider_model_1.default.deleteMany({});
        console.log('Cleared existing data');
        // Seed services
        const createdServices = await Service_model_1.default.insertMany(services);
        ...
        for (let i = 0; i < providerUsers.length; i++) {
            ...
            await Service_model_1.default.updateMany({ _id: { $in: providerServices } }, { $inc: { providersCount: 1 } });
